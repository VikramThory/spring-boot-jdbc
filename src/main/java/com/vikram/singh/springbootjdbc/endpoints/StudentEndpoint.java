package com.vikram.singh.springbootjdbc.endpoints;

import com.vikram.singh.springbootjdbc.dto.StudentDto;
import com.vikram.singh.springbootjdbc.exception.InvalidParametersException;
...
public class StudentEndpoint {
    ...
    public ResponseEntity<Boolean> updateStudent(@PathVariable("id") int studentId, @Valid @RequestBody StudentDto studentDto) {
        ...
        boolean updateStatus = this.studentService.updateStudent(studentId, studentDto);
